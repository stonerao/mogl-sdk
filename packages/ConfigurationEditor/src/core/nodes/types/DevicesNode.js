 ...
 *
 * @example
 * const node = new DevicesNode(scene, {
 *     name: '接入级网元',
 *     properties: {
 *         x: 100,
 *         y: 100,
 ...
 * });
 */
export class DevicesNode extends BaseNode {
    /**
     * 节点类型
     */
    static nodeType = 'devices';
    ...
    setProperty() {
        this.properties = Object.assign({},  this.properties, this.config);
    }
